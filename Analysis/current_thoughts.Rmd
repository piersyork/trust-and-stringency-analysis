...
texreg(list(model4, model5, model6, model7, model7_5, model8, model9), omit.coef = "Intercept", custom.model.names = c("Model 4", "Model 5", "Model 6", "Model 7", "Model 7.5", "Model 8", "Model 9"))
